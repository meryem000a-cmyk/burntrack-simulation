...
class FuelModel:
    ...
    delta: float
    sigma_1h: float
    sigma_live_herb: float
    sigma_live_woody: float
    h_dead: float
    h_live: float
    mx: float
...
BEHAVE_STANDARD: Dict[str, FuelModel] = {
    "GR1": FuelModel(
        ...
        w_1h=0.166, w_10h=0, w_100h=0, w_live_herb=0.067, w_live_woody=0,
        delta=0.305, sigma_1h=11483, sigma_live_herb=10499, sigma_live_woody=7874,
    ...
    "GR2": FuelModel(
        ...
        w_1h=0.166, w_10h=0, w_100h=0, w_live_herb=0.220, w_live_woody=0,
        delta=0.305, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=7874,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "GR3": FuelModel(
        ...
        w_1h=0.166, w_10h=0.667, w_100h=0, w_live_herb=0.327, w_live_woody=0,
        delta=0.610, sigma_1h=7874, sigma_live_herb=6823, sigma_live_woody=7874,
    ...
    "GR4": FuelModel(
        ...
        w_1h=0.415, w_10h=0, w_100h=0, w_live_herb=0.418, w_live_woody=0,
        delta=0.610, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=7874,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "GR5": FuelModel(
        ...
        w_1h=0.667, w_10h=0, w_100h=0, w_live_herb=0.549, w_live_woody=0,
        delta=0.457, sigma_1h=9449, sigma_live_herb=8399, sigma_live_woody=7874,
    ...
    "GR6": FuelModel(
        ...
        w_1h=0.166, w_10h=0, w_100h=0, w_live_herb=0.747, w_live_woody=0,
        delta=0.457, sigma_1h=11483, sigma_live_herb=10499, sigma_live_woody=7874,
    ...
    "GR7": FuelModel(
        ...
        w_1h=1.628, w_10h=0, w_100h=0, w_live_herb=1.189, w_live_woody=0,
        delta=0.914, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=7874,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "GR8": FuelModel(
        ...
        w_1h=0.796, w_10h=1.628, w_100h=0, w_live_herb=1.603, w_live_woody=0,
        delta=1.219, sigma_1h=7874, sigma_live_herb=6823, sigma_live_woody=7874,
        h_dead=18608, h_live=18608, mx=30,
        is_dynamic=True, region="general",
    ...
    "GR9": FuelModel(
        ...
        w_1h=1.628, w_10h=1.628, w_100h=0, w_live_herb=1.976, w_live_woody=0,
        delta=1.524, sigma_1h=9449, sigma_live_herb=8399, sigma_live_woody=7874,
        h_dead=18608, h_live=18608, mx=40,
        is_dynamic=True, region="general",
    ...
    "GS1": FuelModel(
        ...
        w_1h=0.332, w_10h=0, w_100h=0, w_live_herb=0.108, w_live_woody=0.144,
        delta=0.274, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=9449,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "GS2": FuelModel(
        ...
        w_1h=0.796, w_10h=0.796, w_100h=0, w_live_herb=0.131, w_live_woody=0.220,
        delta=0.457, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=9449,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "GS3": FuelModel(
        ...
        w_1h=0.498, w_10h=0.415, w_100h=0, w_live_herb=0.318, w_live_woody=0.273,
        delta=0.549, sigma_1h=9449, sigma_live_herb=8399, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=40,
        is_dynamic=True, region="general",
    ...
    "GS4": FuelModel(
        ...
        w_1h=3.091, w_10h=0.498, w_100h=0.166, w_live_herb=0.747, w_live_woody=1.561,
        delta=0.640, sigma_1h=9449, sigma_live_herb=8399, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=40,
        is_dynamic=True, region="general",
    ...
    "SH1": FuelModel(
        ...
        w_1h=0.415, w_10h=0.415, w_100h=0, w_live_herb=0.031, w_live_woody=0.283,
        delta=0.305, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "SH2": FuelModel(
        ...
        w_1h=2.287, w_10h=4.057, w_100h=1.286, w_live_herb=0, w_live_woody=6.516,
        delta=0.305, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "SH3": FuelModel(
        ...
        w_1h=0.762, w_10h=5.097, w_100h=0, w_live_herb=0, w_live_woody=10.515,
        delta=0.732, sigma_1h=8399, sigma_live_herb=9449, sigma_live_woody=7349,
        h_dead=18608, h_live=18608, mx=40,
        is_dynamic=True, region="general",
    ...
    "SH4": FuelModel(
        ...
        w_1h=1.455, w_10h=1.940, w_100h=0.347, w_live_herb=0, w_live_woody=4.333,
        delta=0.914, sigma_1h=10499, sigma_live_herb=9449, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=30,
        is_dynamic=True, region="general",
    ...
    "SH5": FuelModel(
        ...
        w_1h=6.100, w_10h=3.558, w_100h=0, w_live_herb=0, w_live_woody=4.920,
        delta=1.829, sigma_1h=3937, sigma_live_herb=9449, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "SH6": FuelModel(
        ...
        w_1h=4.922, w_10h=2.461, w_100h=0, w_live_herb=0, w_live_woody=2.354,
        delta=0.610, sigma_1h=3937, sigma_live_herb=9449, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=30,
        is_dynamic=True, region="general",
    ...
    "SH7": FuelModel(
        ...
        w_1h=5.929, w_10h=8.977, w_100h=3.704, w_live_herb=0, w_live_woody=5.754,
        delta=1.829, sigma_1h=3937, sigma_live_herb=9449, sigma_live_woody=8399,
        h_dead=18608, h_live=18608, mx=15,
        is_dynamic=True, region="general",
    ...
    "SH8": FuelModel(
        ...
        w_1h=3.466, w_10h=5.754, w_100h=1.455, w_live_herb=0, w_live_woody=7.348,
        delta=0.914, sigma_1h=3937, sigma_live_herb=9449, sigma_live_woody=7874,
        h_dead=18608, h_live=18608, mx=40,
        is_dynamic=True, region="general",
    ...
    "SH9": FuelModel(
        ...
        w_1h=7.626, w_10h=4.155, w_100h=0, w_live_herb=0.245, w_live_woody=11.849,
        delta=1.341, sigma_1h=3937, sigma_live_herb=9449, sigma_live_woody=7874,
        h_dead=18608, h_live=18608, mx=40,
        is_dynamic=True, region="general",
...
AFRICA_NORTH: Dict[str, FuelModel] = {
    ...
    "AF_STEPPE_DENSE": FuelModel(
        ...
        delta=0.40, sigma_1h=10000, sigma_live_herb=10000, sigma_live_woody=3000,
    ...
    "AF_ARGAN": FuelModel(
        ...
        delta=0.35, sigma_1h=8000, sigma_live_herb=8000, sigma_live_woody=2800,
    ...
    "AF_CHENE_LIEGE": FuelModel(
        ...
        delta=0.30, sigma_1h=8000, sigma_live_herb=8000, sigma_live_woody=3500,
    ...
    "AF_CEDRE": FuelModel(
        ...
        delta=0.25, sigma_1h=10000, sigma_live_herb=10000, sigma_live_woody=4000,
    ...
    "AF_MAQUIS": FuelModel(
        ...
        delta=0.50, sigma_1h=7000, sigma_live_herb=7000, sigma_live_woody=3000,
    ...
    "AF_PALMIER": FuelModel(
        ...
        delta=0.30, sigma_1h=6000, sigma_live_herb=6000, sigma_live_woody=2500,
    ...
    "AF_TAMARIX": FuelModel(
        ...
        delta=0.40, sigma_1h=7000, sigma_live_herb=7000, sigma_live_woody=2800,
    ...
    "AF_JUJUBIER": FuelModel(
        ...
        delta=0.35, sigma_1h=6000, sigma_live_herb=6000, sigma_live_woody=2500,
...
AFRICA_SAVANNA: Dict[str, FuelModel] = {
    ...
    "AF_MIOMBO": FuelModel(
        ...
        delta=0.50, sigma_1h=9000, sigma_live_herb=9000, sigma_live_woody=3000,
    ...
    "AF_MIOMBO_DENSE": FuelModel(
        ...
        delta=0.60, sigma_1h=8000, sigma_live_herb=8000, sigma_live_woody=2800,
    ...
    "AF_MOPANE": FuelModel(
        ...
        delta=0.45, sigma_1h=8000, sigma_live_herb=8000, sigma_live_woody=2800,
    ...
    "AF_ACACIA_SAVANNA": FuelModel(
        ...
        delta=0.50, sigma_1h=10000, sigma_live_herb=10000, sigma_live_woody=3500,
        h_dead=18600, h_live=19500, mx=20,
    ...
    "AF_GRASSLAND_FERTILE": FuelModel(
        ...
        w_1h=0.40, w_10h=0.05, w_100h=0, w_live_herb=0.50, w_live_woody=0,
        delta=0.80, sigma_1h=12000, sigma_live_herb=12000, sigma_live_woody=7874,
    ...
    "AF_FYNBOS": FuelModel(
        ...
        delta=0.70, sigma_1h=12000, sigma_live_herb=12000, sigma_live_woody=4500,
    ...
    "AF_FYNBOS_YOUNG": FuelModel(
        ...
        w_1h=0.20, w_10h=0.08, w_100h=0, w_live_herb=0.03, w_live_woody=0.15,
        delta=0.30, sigma_1h=12000, sigma_live_herb=12000, sigma_live_woody=5000,
        h_dead=20000, h_live=21000, mx=25,
        is_dynamic=True, region="south_africa",
    ...
    "AF_BUSHVELD": FuelModel(
        ...
        delta=0.80, sigma_1h=9000, sigma_live_herb=9000, sigma_live_woody=3000,
        h_dead=19500, h_live=20000, mx=22,
        is_dynamic=True, region="south_africa",
    ...
    "AF_BAOBAB": FuelModel(
        ...
        w_1h=0.20, w_10h=0.05, w_100h=0, w_live_herb=0.25, w_live_woody=0.08,
        delta=0.40, sigma_1h=12000, sigma_live_herb=12000, sigma_live_woody=3000,
        h_dead=18600, h_live=19000, mx=18,
    ...
    "AF_FOREST_DRY": FuelModel(
        ...
        delta=0.50, sigma_1h=8000, sigma_live_herb=8000, sigma_live_woody=3000,
    ...
    "AF_AFROMONTANE": FuelModel(
        ...
        delta=0.40, sigma_1h=9000, sigma_live_herb=9000, sigma_live_woody=3500,
    ...
    "AF_MANGROVE": FuelModel(
        ...
        delta=0.50, sigma_1h=7000, sigma_live_herb=7000, sigma_live_woody=2500,
